...
export const question = [
    ...
    {
        key: 'q5',
        label: '5. 以一个百分比来表示，你认为你的作文能打多少分？',
        options: [
    ...
    {
        key: 'q7',
        label: '7. 在写作时最常遇到的困难是什么？',
        options: [
            {label: 'A. 对题目理解不深，无从下笔，没有创作思路。', value: 'A'},
            {label: 'B. 语句组织有困难，无法流畅表达意思。', value: 'B'},
            {label: 'C. 内容材料不足，写作时常感到素材匮乏。', value: 'C'},
            {label: 'D. 修辞手法使用不当，无法美化文章。', value: 'D'},
            {label: 'E. 缺乏创新思维，写出的内容平淡无奇。', value: 'E'}]
    },
    {
        key: 'q8',
